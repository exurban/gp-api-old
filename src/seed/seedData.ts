...
export const subjects = ["bird", "bloom", "beast", "land", "water", "sky"];
...
export const collectionData = [
  {
    name: "Autumn in the Rockies",
    tag: "autumn",
    description:
      "Photos highlighting the changing seasons in Rocky Mountain National Park",
  },
  {
    name: "Winter at Yellowstone National Park",
    tag: "winter",
    description: "Winter at Yellowstone.",
  },
  {
    name: "Night Photography",
    tag: "stars",
    description: "Photos of the Heavens",
  },
];
